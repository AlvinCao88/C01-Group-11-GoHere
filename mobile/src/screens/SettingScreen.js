    ...
    <ScrollView style={styles.scrollViewStyle}>
      <SafeAreaView style={styles.container}>
        <View style={styles.headerContainer}>
          <Text style={[styles.titleText, { color: "#DA5C59" }]}>Settings</Text>
        </View>
        <TouchableOpacity
          style={styles.button}
          activeOpacity={0.3}
        ...
        <TouchableOpacity style={styles.button} activeOpacity={1}>
          ...
          <Text style={styles.smallText}>
            Enable analytics to send anonymous usage to support app
            improvements.
          </Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.3}
          onPress={() =>
            Linking.openURL("https://crohnsandcolitis.ca/Privacy-Policy")
          }
        >
          <View style={styles.arrow}>
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            Linking.openURL(
              `mailto:${supportEmailAddress}?subject=${supportEmailSubject}`
            )
          }
        >
          <View style={styles.arrow}>
            <Text style={styles.buttonText}>Request Support</Text>
            <Ionicons name="chevron-forward-outline" size={16}></Ionicons>
          </View>
        </TouchableOpacity>
        ...
        >
          <View style={styles.arrow}>
            <Text style={styles.buttonText}>Add a Washroom</Text>
            <Ionicons name="chevron-forward-outline" size={16}></Ionicons>
          </View>
        </TouchableOpacity>
